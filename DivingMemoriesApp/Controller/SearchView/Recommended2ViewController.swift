...
class Recommended2ViewController: UIViewController,UIScrollViewDelegate {
    ...
    var imageArray = ["平石崎マンタスクランブル2","平石崎マンタスクランブル1","平石崎マンタスクランブル3"]
    var labelNameArray = ["川平石崎マンタスクランブル"]
    var addressArray = ["〒907-0453 沖縄県石垣市川平"]
